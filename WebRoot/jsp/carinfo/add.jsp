...
<body>
    <div class="mformbody">
        <form action="sys/addCarInfoAction.action" name="userForm" method="post" enctype="multipart/form-data">
        <ul class="mforminfo">
            <li><label>车牌号</label><input name="" id="id_card" type="text" class="mdfinput" style="width: 400px;" onblur="isIDno()"/><span id="message"></span></li>
            <li><label>车辆名称</label><input name="" id="account" type="text" class="mdfinput" /></li>
            <li><label>租借金额</label><input name="" id="user_name" type="text" class="mdfinput" /></li>
            <li><label>车辆颜色</label><input name="" id="email" type="text" class="mdfinput" onblur="isEmail()"/></li>
            <li><label>购买价格</label><input name="" id="telphone" type="text" class="mdfinput" onblur="checkMobile()"/><span id="telmessage"></span></li>
            <li><label>车辆保证金</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>登记人的姓名</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>车辆保证金</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>汽车行驶公里数</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>登记人的姓名</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>车辆类型</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>车辆图片</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>车辆状态</label><input name="" id="birthday" type="text" class="mdfinput" /></li>
            <li><label>性别</label>
