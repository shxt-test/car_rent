  ...
  <head>
    ...
    <script type="text/javascript" src="<%=path %>/resource/admin/js/jquery.js"></script>
     <script type="text/javascript">
        ...
        function toCancelReserveCarDialog(){
	            ...
	            var d = top.dialog({
	                ...
	                ok: function () {
	                    this.title('提交中…');
	                      ...
	                      $.post("sys/toCancelReserveCarInfoAction.action",params,function(data){
        ...
        <tbody>
            <s:iterator value="pageBean.datas" var="carInfo" status="st">
                <tr>
		            ...
		            <td>
	                    <s:if test="#carInfo.car_status==2">
	                        <span style="color:blue;font-weight:blod;">预定</span>
	                    </s:if>
                    </td>
		            
		            <td><a href="javascript:void(0)" onclick="toCancelReserveCarDialog()">取消预定</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		              <a href="javascript:void(0)" onclick="toRentCarDialog()">租车</a>
		            </td>
	            </tr> 
            </s:iterator>
        </tbody>
